...
const Header = ({ showSidebar, setShowSidebar }) => {
  ...
  return (
    <div className=' fixed top-0 left-0 w-full py-5 px-2 lg:px-7 z-40'>
      <div className='ml-0 lg:ml-[260px] shadow-md rounded-md h-[65px] flex justify-end items-center bg-white text-[#2B2A4C] px-5 transition-all'>
        ...
        <Link to='/seller/dashboard/profile' className='flex justify-center items-center gap-8 relative'>
