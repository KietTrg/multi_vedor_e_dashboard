      ...
      <div className=' w-[350px] text-[#d0d2d6] p-2'>
        <div className='bg-[#283046] rounded-md p-4'>
          ...
          <form onSubmit={submit}>
            ...
            <button disabled={loader ? true : false} className='bg-blue-500 w-full hover:shadow-blue-500/50 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3'>{loader ? <PropagateLoader color='#fff' cssOverride={overideStyle} /> : 'Sign In'}</button>
            <div className='flex items-center mb-3 gap-3 justify-center'>
              <p>Already have an account ? <Link to='/register'>Sign up here</Link></p>
            </div>
