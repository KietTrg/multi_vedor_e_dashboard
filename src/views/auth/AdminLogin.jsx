    ...
    <div className=' min-w-screen min-h-screen bg-[#161d31] flex items-center justify-center'>
      <div className=' w-[350px] text-[#d0d2d6] p-2'>
        ...
        <form onSubmit={submit}>
          ...
          <button disabled={loader?true: false} className='bg-blue-500 w-full hover:shadow-blue-500/50 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3'>{loader ? <PropagateLoader color='#fff' cssOverride={overideStyle}/> : 'Login'}</button>
