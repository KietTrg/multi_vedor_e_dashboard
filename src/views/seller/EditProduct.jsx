            ...
            <div className='w-full bg-white shadow-md p-4 rounded-md'>
                <div className='flex justify-between items-center pb-4'>
                    ...
                    <Link className='transition-all duration-500 bg-[#739072] px-7 py-2 rounded-md my-2 text-white hover:bg-[#3a4d39]'
                        to='/seller/dashboard/all-product'>Back</Link>
                </div>
                <div>
                    <form onSubmit={update}>
                        <div className='flex flex-col mb-3 md:flex-row gap-4 w-full text-[#2B2A4C]'>
                            <div className='flex flex-col w-full gap-1'>
                                ...
                                <input className='px-3 py-2 outline-none border bg-transparent border-slate-700 rounded-md text-[#2a2b4c] focus:border-green-500 overflow-hidden'
                        ...
                        <div className='flex flex-col mb-3 md:flex-row gap-4 w-full text-[#2B2A4C'>
                            <div className='flex flex-col w-full gap-1 relative'>
                                ...
                                <input readOnly onClick={() => setCateShow(!cateShow)} className=' text-[#2A2B4C] px-3 py-2 outline-none border bg-transparent border-slate-700 rounded-md  focus:border-green-500 overflow-hidden'
                        ...
                        <div className='flex flex-col w-full gap-1 mb-5'>
                            ...
                            <textarea rows={8} className='px-3 py-2 outline-none border bg-transparent border-slate-700 rounded-md text-[#2a2b4c] focus:border-green-500 overflow-hidden'
                        ...
                        <div className='grid lg:grid-cols-4 grid-cols-1 md:grid-cols-3 sm:grid-cols-2 sm:gap-4 md:gap-4 xs:gap-4 gap-3 w-full text-[#2a2b4c] mb-4'>
                            ...
                            <label className='flex justify-center items-center flex-col h-[180px] cursor-pointer border border-dashed border-black hover:border-green-700 w-full text-[#2a2b4c]' htmlFor="image">
                                <span><BsImage></BsImage></span>
                                <span>Select Image</span>
                            </label>
