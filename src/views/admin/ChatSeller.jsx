                ...
                <div className='flex w-full h-full relative text-[#2B2A4C]'>
                    <div className={`w-[280px] h-full absolute z-10 ${show ? '-left-4' : '-left-[336px]'} md:left-0 md:relative transition-all`}>
                        <div className='w-full h-[calc(100vh-177px)] bg-slate-100 rounded-md md:bg-transparent overflow-y-auto'>
                            ...
                            {sellers.map((el, i) => <div key={i} className={`h-[60px] flex justify-start gap-2 items-center text-[#2B2A4C] p-2 ${sellerId === el._id}`}>
                    ...
                    <div className='w-full md:w-[calc(100%-200px)] md:pl-4'>
                                                ...
                                                <div className='w-full flex justify-start items-center'>
                                                    <div className='flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]'>
                                                        ...
                                                        <div className='py-2 px-3 rounded-md flex justify-center items-start flex-col w-full bg-[#e95353]'>
                                                            ...
                                                            <span className='text-white text-base font-light'>Lorem  </span>
                                                        </div>
                                                    </div>
                                                </div>
                                            )
                        ...
                        <form className='flex gap-3'>
                            <input readOnly={sellerId ? false : true} type="text" placeholder='input your message' className='w-[calc(100%-150px)] border border-slate-700 px-4 py-2 rounded-md outline-none focus:border-red-700 bg-transparent text-[#2B2A4C] ' />
