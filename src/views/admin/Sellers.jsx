                        ...
                        <tbody>
                            {
                                [1, 2, 3, 4, 5].map((el, key) => <tr key={key}>
                                    ...
                                    <td scope='row' className='py-3
                                             px-4 font-medium whitespace-nowrap'><span>Kiet Truong</span></td>
                                    <td scope='row' className='py-3
                                             px-4 font-medium whitespace-nowrap'><span>Kiet Truong Shop</span></td>
                                    <td scope='row' className='py-3
                                             px-4 font-medium whitespace-nowrap'><span>pending</span></td>
                                    <td scope='row' className='py-3
                                             px-4 font-medium whitespace-nowrap'><span>kietb2016977@student.ctu.edu.vn</span></td>
                                    <td scope='row' className='py-3
                                             px-4 font-medium whitespace-nowrap'><span>Kiet Truong</span></td>
                                    <td scope='row' className='py-3
                                             px-4 font-medium whitespace-nowrap'><span>Hau Giang</span></td>
                                    <td scope='row' className='py-3
                                             px-4 font-medium'>
                                        <div className='flex justify-start  items-center gap-4'>
                                            <Link to='/admin/dashboard/sellers/detail/1'><LuEye color='#3e59e1' size={17} /></Link>
                                        </div>
                                    </td>
                                </tr>)
                            }
